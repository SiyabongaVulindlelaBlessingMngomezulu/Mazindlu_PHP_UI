...
<div id="content"><table width="928" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <div id="main_content">
      <br>
    <h1>About SigarTech.</h1>
    <h3>Hi, we're SigarTech, it's nice to meet you.</h3><br>
    <p>SigarTech is passionate about helping students find perfect accommodation in and around Roodepoort. We also provide a marketing platform for property owners to connect with student tenants searching for accommodation online. In addition, students can find properties, bungalow houses, apartments, townhouses, condominium, and penthouses in and Roodepoort. With the numerous property listings for rent and sale from various Estate Agents, searching for a convenient property has been made so much easier for students. </p>
    <p>&nbsp;</p>
    <p>SigarTech is also committed to helping students find convenient accommodations through major website platform which delivers great user experience and advanced search services tools. For sale enquiries, billing enquiries, report a problem or request support on any of our services, <a href="contact.php"><strong>Contact Us</strong></a> or leave us a message <a href="feedback.php"><strong>here</strong></a>.  </p>
    <p>&nbsp;</p>
    <div id="house_sales">
  </div>
    </div>
