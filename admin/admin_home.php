        ...
        ?>
			...
			<tbody> 
				<tr> 
    				...
    				<td>
                    <a href="delete_feedback.php?id_feedback=<?php echo $row['id_feedback'];?>" onClick="alert('Are you sure want to DELETE this data????');"><img src="images/icn_trash.png"></a></td> 
				</tr>
        ...
        ?>
			...
			<tbody> 
				<tr> 
    				...
    				<td><a href="delete_message.php?name=<?php echo $row['name'];?>" onClick="alert('Are you sure want to DELETE this data????');"><img src="images/icn_trash.png"></a>
                    </td> 
				</tr>
