...
<body>
	...
	<section id="main" class="column">
      ...
      <article class="module width_full">
	    <header><h3>Book details</h3></header>
        <p>
          <?php
...
$sql="SELECT*FROM $tbl_name GROUP BY id_book DESC";
...
<tr>
<td width="92" align="center" bgcolor="#999999"><font color="white"><strong>Book Title</strong></td>
...
><td align="center" bgcolor="#E2E2E2"><a href="delete_book.php?book_title=<?php echo $row['book_title'];?>" onClick="alert('Are you sure you want to DELETE this data????');"><img src="images/icn_trash.png"/></a><form id="form1" name="form1" method="post" action="upload.php">
