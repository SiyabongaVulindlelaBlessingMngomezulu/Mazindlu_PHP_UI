...
<li><a href="user_home.php">Home</a></li>
	  ...
	  <ul class="toggle">
	   ...
	   <!--<h3>Users</h3>
		...
		<h3>User</h3>
		<ul class="toggle">
			<!--<li class="icn_jump_back"><a href="user_home.php">Home</a></li>-->
	...
	<section id="main" class="column">
	  ...
	  <div class="clear"></div>
		...
		<article class="module width_full">
			<header><h3>List New Books</h3></header>
			<p>
			  <?php
include("bookconnection.php");
...
$insert_sql="INSERT INTO book VALUES('', '$book_title', '$book_format', '$author', '$ISBN', '$book_price', '$price_type', '$edition', '$contact_no', '$publisher', '$publication_date','$text', '$user_id')";

$sql_result=mysqli_query($db, $insert_sql) or die("Error in inserting data due to
".mysqli_error($db));

if($sql_result)
echo "<a href='user_view.php'><h4 class='alert_success'>A Success Message</h4></a>";
else
