...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="admin_home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current">Customer</a></article>
		</div>
...
$insert_sql="INSERT INTO customer VALUES('', '$id_property', '$name', '$mobile_phone', '$cus_email', '$date', '$reason')";
