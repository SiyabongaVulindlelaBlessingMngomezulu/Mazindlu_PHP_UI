...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="admin_home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current">Delete Book</a></article>
		</div>
	...
	<section id="main" class="column">
	  ...
	  <div class="clear"></div>
		...
		<article class="module width_full">
			<header><h3>Delete a book</h3></header>
			<p>
<?php
...
$sql="DELETE FROM $tbl_name WHERE book_title='$book_title'";
