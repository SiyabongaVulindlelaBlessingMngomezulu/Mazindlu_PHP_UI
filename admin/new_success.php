...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="admin_home.php">Home</a> <div class="breadcrumb_divider"></div> <a class="current">Book Add Successful</a></article>
		</div>
	...
	<section id="main" class="column">
	  ...
	  <div class="clear"></div>
		...
		<article class="module width_full">
			<header><h3>List New Property</h3></header>
			<p>
			  <?php
...
$insert_sql="INSERT INTO property VALUES('', '$name_property', '$type_property', '$address', '$post_code', '$price', '$price_type', '$leasehold', '$beds', '$baths', '$contact_no','$text')";
