...
<body>
	...
	<section id="main" class="column">
	  <article class="module width_full">
        ...
        <tr>
        <td height="47"><font color="black"><?php echo $row['name'];?></td
        ><td width="180"><font color="black"><?php echo $row['myusername'];?></td
        ><td><font color="black"><?php echo $row['mypassword'];?></td
        ...
        <input name="hf_uname" type="hidden" id="hf_uname" value="<?php echo $row['myusername']; ?>" />
      </form></td>
