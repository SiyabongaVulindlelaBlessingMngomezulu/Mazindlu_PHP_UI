...
$con = mysqli_connect("$host","$username","$password", "property")or die("cannot connect");
...
><td bgcolor="#E2E2E2"><font color="black"><?php echo $rows['beds'];?></td
><td bgcolor="#E2E2E2"><font color="black"><?php echo $rows['baths'];?></td
><td align="center" bgcolor="#E2E2E2"><a href="user_delete_property.php?name_property=<?php echo $rows['name_property'];?>" onClick="alert('Are you sure want to DELETE this data????');"><img src="images/icn_trash.png"/></a><form id="form1" name="form1" method="post" action="user_upload.php">
