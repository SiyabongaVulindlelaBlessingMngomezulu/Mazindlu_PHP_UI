...
<body>
	...
	<section id="main" class="column">
	  <article class="module width_full">
	    <header>
	      <h3>VIEW CUSTOMERS</h3></header>
        <p>This is a list showing details of available customers.</p>
			            <p>
			              <?php
...
<tr>
<td width="71" align="center" bgcolor="#999999"><font color="white"><strong>Email</strong></td>
<td width="167" align="center" bgcolor="#999999"><font color="white"><strong>Name</strong></td>
<td width="132" align="center" bgcolor="#999999"><font color="white"><strong>Surname</strong></td>
<td width="105" align="center" bgcolor="#999999"><font color="white"><strong>Bio</strong></td>
<td width="84" align="center" bgcolor="#999999"><font color="white"><strong>Address</strong></td>
<td width="150" align="center" bgcolor="#999999"><font color="white"><strong>Username</strong></td>
...
<tr>
<td bgcolor="#E2E2E2"><font color="black"><center><?php echo $row['user_email'];?></center></td>
<td bgcolor="#E2E2E2"><font color="black"><?php echo $row['user_firstname'];?></td
><td bgcolor="#E2E2E2"><font color="black"><?php echo $row['user_lastname'];?></td
><td bgcolor="#E2E2E2"><font color="black"><?php echo $row['user_shortbio'];?></td
><td bgcolor="#E2E2E2"><font color="black"><?php echo $row['user_address'];?></td
><td bgcolor="#E2E2E2"><font color="black"><?php echo $row['user_username'];?></td
><td align="center" bgcolor="#E2E2E2"><a href="delete_customer.php?user_id=<?php echo $row['user_id'];?>" onClick="alert('Are you sure want to DELETE this data????');"><img src="images/icn_trash.png"/></a></td>
