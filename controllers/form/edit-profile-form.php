...
<form action="components/update-profile.php" method="post" enctype="multipart/form-data" id="UploadForm">
                ...
                <div class="form-group float-label-control">
                    ...
                    <div class="col-md-6">
                        <div class="shortpreview">
                            <label for="">Previous Picture </label>
                            <br> 
                    ...
                    <div class="col-md-6">
                        <div class="shortpreview" id="uploadImagePreview">
                            <label for="">Current Uploaded Picture </label>
                            <br> 
 ...
 <div class="form-group float-label-control">
  ...
  <select class="form-control" id="country" placeholder="<?php echo $rws['user_country'];?>" required="true" name="user_country" id="country">
