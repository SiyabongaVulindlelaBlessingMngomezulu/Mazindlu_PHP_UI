    ...
    <div class="row clearfix">
        ...
        <div class="col-md-4">
            <ul class="nav text-center">
                ...
                <li><a href="admin/admin_new-2.php">Upload Property</a></li>
				<li><a href="admin/admin_view-2.php">View all your property</a></li>
                <li><a href="admin/book_new.php">Upload Book!</a></li>
				<li><a href="books_new.php">View listed books</a></li>
            </ul>
        </div>
        <div class="col-md-4"></div>
    </div>
